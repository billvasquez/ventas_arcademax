...
<html>
    ...
    <div class="zona_impresion">
        ...
        <br>
        @foreach ($venta as $v)
        <table border="0" align="center" width="219px">
            <tr>
                <td align="center">
                <!-- Mostramos los datos de la empresa en el documento HTML -->
                .::<strong> Arca de Max </strong>::.<br>
                RUC 10377157772<br>
                Jr Huallayco #856, Huánuco - Perú - 987654321<br>
                </td>
            </tr>
            <tr>
        ...
        <table border="0" align="center" width="58px">
            <tr>
                <td>CANT.</td>
                <td>DESCRIPCIÓN</td>
            ...
            <td align="right"><b>$ {{ number_format($v->total,2) }}</b></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            <td align="right"><b>IMPUESTO:</b></td>
            <td align="right"><b>$ {{  number_format($v->total*$v->impuesto,2) }}</b></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            ...
            <tr>
            <td colspan="3" align="center">Arca de Max</td>
            </tr>
            <tr>
            <td colspan="3" align="center">Huánuco - Perú</td>
            </tr>            
        </table>
        <br>
        </div>
