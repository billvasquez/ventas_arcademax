...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/.png" alt="Novedadesyanelly" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Arca de Max</b><br>Jr Huallayco #856, Huánuco - Perú<br>Telefono:(+51)987456321<br>Email:ventas_yanelly@gmail.com
                </p>
            </div>
            <div id="fact">
